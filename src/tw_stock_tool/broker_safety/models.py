...
class FindingCode(StrEnum):
    ...
    AUTHORIZATION_TTL_EXCEEDED = "AUTHORIZATION_TTL_EXCEEDED"
    AUTHORIZATION_BOUNDS_EXCEEDED = "AUTHORIZATION_BOUNDS_EXCEEDED"
    SAFETY_FINDINGS_MISMATCH = "SAFETY_FINDINGS_MISMATCH"
    INTENT_BOUNDS_EXCEEDED = "INTENT_BOUNDS_EXCEEDED"
