...
- P3.1 characterization branch: track-p3-1-subprocess-test-helper-characterization
- Parent branch: fix-p3-1-console-script-ci-portability
- Correct parent: 7a46af2acf75bca6f4eac592afd4ea2c0734b8ef
- P3.1 characterization commit: ae5eb66903c4fb107428596325f90fae788e7dbf
- Implementation branch: track-p3-2-shared-subprocess-test-helper-v2
- Current implementation commit before commit creation: 7a46af2acf75bca6f4eac592afd4ea2c0734b8ef
- Superseded P3.2 source commit: 298e8add302b066fb25c8a0af28dd48be7c49af1
- No rebase, merge, squash, amend, force-push, or PR was performed.

Complete stacked-parent relationship:

    43402917cdf05822dfcd5622d96c8bdd46eae5cc
      main baseline

    ae5eb66903c4fb107428596325f90fae788e7dbf
      P3.1 characterization

    7a46af2acf75bca6f4eac592afd4ea2c0734b8ef
      CI portability fix

    new P3.2 commit (this implementation)
      shared subprocess test helper

Recovery note: the first P3.2 branch was created before the CI portability fix. It was not rewritten. Its implementation diff was reapplied with cherry-pick --no-commit, so the corrected P3.2 commit is based directly on 7a46af2acf75bca6f4eac592afd4ea2c0734b8ef. The installed twstock subprocess assumption remains removed. The superseded 298e8add302b066fb25c8a0af28dd48be7c49af1 is not the final implementation commit.
...
The before snapshot was read from the exact corrected parent 7a46af2acf75bca6f4eac592afd4ea2c0734b8ef. The helper was counted as zero before and 33 nonblank lines after. No permanent counting script was added.
...
Final validation for the corrected v2 implementation:

- git diff --check: PASS;
- exactly the nine approved files changed: PASS;
- no test method was removed or renamed: PASS;
- all nine changed files are UTF-8 without BOM: PASS;
- no expected failure or skip was added: PASS;
- no live network request occurred: PASS;
- no persistent helper directory, bytecode, cache, or output artifact remains: PASS;
- custom_md.md was not inspected or changed: PASS;
- working tree is clean after commit: PASS;
- superseded branch was not rewritten or force-pushed: PASS.
